...
function zero_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'zero' ),
	) );
...
function zero_scripts() {
	wp_enqueue_style('zero-bootstrap', get_template_directory_uri() . '/assets/css/bootstrap.min.css');
	wp_enqueue_style( 'zero-style', get_stylesheet_uri() );

	wp_enqueue_script( 'zero-bootstrap-script', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array('jquery'), '', true );
